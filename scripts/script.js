    ...
    const popupAddCard = document.querySelector('.cards_add');
    ...
    const popUpImgView = document.querySelector('.img__view');
    const popupImgCloseBtn = document.querySelector('.popup__close-icon_img');
    // Находим форму в DOM
    let formElement = document.querySelector('.form');
    let addCardFormElement = document.querySelector('.card_add');
